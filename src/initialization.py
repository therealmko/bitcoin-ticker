...
class Initializer:
    ...
    async def _fetch_current_version(self):
        ...
        try:
            # Add User-Agent to URL as GitHub requires it
            response = urequests.urlopen(
                "https://api.github.com/repos/satoshiradio/bitcoin-ticker/releases/latest?client=SR-Ticker-1.0"
            )
